        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center space-x-3 mb-8">
              ...
              <div>
                <span className="text-2xl font-bold text-white tracking-tight">CPA Hex</span>
                <p className="text-sm text-gray-400 font-medium">AI Dashboard</p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-gray-400">Sign in to your CPA Hex account</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {connectionError && !error && (
              <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-4">
                <p className="text-yellow-400 text-sm">Connection to authentication service is currently unavailable. Sign-in may not work properly.</p>
              </div>
            )}
            {error && (
            ...
            <div className="space-y-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-200"
                  required
                />
              </div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-4 bg-gray-800 border border-gray-700 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary/50 transition-all duration-200"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center space-x-4 mb-4">
              <div className="flex -space-x-2">
                <div className="w-10 h-10 bg-primary rounded-full border-2 border-white flex items-center justify-center">
                  <span className="text-sm font-semibold text-gray-900">JD</span>
                </div>
                ...
                <div className="w-10 h-10 bg-emerald-500 rounded-full border-2 border-white flex items-center justify-center">
                  <span className="text-sm font-semibold text-white">AL</span>
                </div>
              </div>
              <span className="text-white/90 font-medium">Trusted by 2,500+ CPAs</span>
            </div>
            <p className="text-white/80 italic">
              "CPA Hex has transformed how we handle tax season. The AI insights save us hours every day."
            </p>
            <p className="text-white/70 text-sm mt-2">— Sarah Chen, Managing Partner</p>
          </div>
        </div>
      </div>
    </div>
