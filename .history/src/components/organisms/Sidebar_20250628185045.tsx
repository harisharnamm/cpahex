...
export function Sidebar({ isOpen = true, onClose }: SidebarProps) {
  ...
  return (
    <aside className={`fixed left-0 top-0 z-40 w-72 h-screen bg-surface-elevated border-r border-border-subtle backdrop-blur-sm transition-transform duration-300 ${
